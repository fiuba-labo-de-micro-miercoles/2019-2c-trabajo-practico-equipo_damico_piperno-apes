...
;codigo binario de peso para cota menor de detección de pulsos/vasos
.equ PESO_UMBRAL_H = 0x02
.equ PESO_UMBRAL_M = 0x00
.equ PESO_UMBRAL_L = 0x00

;codigo binario de peso para cota mayor de detección de pulsos/vasos
.equ PESO_MAX_H = 0x05
.equ PESO_MAX_M = 0xFE 
.equ PESO_MAX_L = 0x00
...
cerrar_bomba_2:
	...
	ret
;------------------------- leer_hx711 ---------------------------------------
;lee el peso obtenido por el módulo amplificador conversor y lo guarda en la ram en la posicion "dato_hx711"
leer_hx711:
	push NRO_BITS_HX711
	push A
	push peso_leido_L
